...
export const AboutPath = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto py-16 mt-14 sm:px-6 md:px-8 flex flex-col gap-8 relative">
        <div className="flex mb-8 absolute md:-top-[22%] top-[0%]">
          <Image
            src={scale}
            alt="scale-image"
            className="-z-10 top-0 opacity-40"
          />
        </div>
